...
The accompanying script `script_fix_broken_migration.py` is meant to be used on top of a broken installation (7.2.9 - 8.0.5: NOTE - this will not work with 8.0.6).
...
The commands need to be executed in a CML session started using the newer (7.2.9 - 8.0.5) version of CDV.
